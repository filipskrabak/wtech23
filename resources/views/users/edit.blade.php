      ...
      <div class="col-md-6">
        ...
        @csrf
          ...
          <div class="row">
            <div class="col-lg-3">
              <div class="form-floating mb-3">
                <input type="text" class="form-control @error('postcode') is-invalid @enderror" id="postcodeInput" @isset($user->postcode->postcode)
                value="{{$user->postcode->postcode}}"@endisset placeholder="Pezinská" name="postcode">
            ...
            <div class="col-lg-9">
              <div class="form-floating mb-3">
                ...
                value="{{$user->street->name}}"@endisset placeholder="Pezinská" name="street">
